...
# def subsample(img_seq, ss_rate):
#     # seq_len = img_seq.shape[0]
#     return img_seq[0:-1:ss_rate]
...
#%% try loading and transforming one video from Ego4D
# clip_dir = 
fname = "aa66b3ec-65c0-4ca1-a989-2224e57ef6b3.mp4"

crop_size = 256
clip_tuple = torchvision.io.read_video(fname)
xtt = subsample(clip_tuple[0], 30)
...
ztt = transforms_ego4d(xtt)

ztt_diff = torch.diff(ztt, n=1, dim=0)

_ = plt.hist(ztt_diff.numpy().flatten(), bins=20)
